...
const Login = () => {
    ...
    const onSubmitHandler = async (e) => {
        try {
            ...
            if (state === 'Sign Up') {
                console.log("Sending data:", { name, email, password, role });  // Log data for debugging
            ...
            <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
                ...
                <form onSubmit={onSubmitHandler}>
                    {state === 'Sign Up' && (
                        <>
                            ...
                            <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                                ...
                                <select onChange={e => setRole(e.target.value)} value={role} className='bg-transparent outline-none w-full text-indigo-300'>
                    ...
                    <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                        ...
                        <input onChange={e => setEmail(e.target.value)} value={email} className='bg-transparent outline-none w-full' type="email" placeholder="Email id" required/>
                    </div>
